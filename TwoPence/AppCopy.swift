...
struct AppCopy {
    ...
    static let onboardingScreen1 = "Swipe to learn more"
    static let onboardingScreen2 = "TwoPence makes savings simple. \n\n TwoPence generates savings by adding an extra 10% to every dollar you spend."
    static let onboardingScreen3 = "TwoPence makes accountability easy. \n\n These savings are automatically withdrawn from your account and sent as additional payments to your student loan."
